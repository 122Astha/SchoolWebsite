...
<?php require('inc/header.php'); ?>
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        <ul class="carousel-indicators">
            <?php
                $slider_count_query = "SELECT * FROM sliders";
                ...
                while($data=mysqli_fetch_array($slider_count_result))
                {
                    $count+=1;
            ?>
            <li data-target="#demo" data-slide-to="<?php echo $data_slide; ?>" class="<?php if($count==1) { echo "active"; } ?>"></li>
            <?php
                $data_slide+=1;
                }
            ?>
        ...
        <?php
            ...
            <div class="carousel-item <?php if($count==1) { echo "active"; } ?>">
                <img src="uploads/<?php echo $data['img']; ?>" alt="education" class="img-fluid">
                <div class="carousel-caption animated fadeInLeft delay-0.5s">
                    <h1 class="font-weight-bold"><?php echo $data['h1'] ?></h1>
                    <h6 class="banner-desc"><?php echo $data['p']; ?></h6>
                    <a href="<?php echo $data['btn_link']; ?>" class="theme-orange btn mt-3 apply-now"><?php echo $data['btn_txt']; ?></a>
                </div>
            </div>
                    <?php
          }
    ...
    <section class="about-us" data-aos="fade-up" data-aos-duration="950">
        <div class="container">
            ...
            <h5 class="pt-3">Santosh Acharya</h5>
            <p>Principal</p>
    ...
    <section class="target">
        <div class="container">
            ...
            <div class="row">
            <?php
                $select_why_choose_us = "SELECT * FROM why_choose_us";
                $result_why_choose_us = mysqli_query($conn,$select_why_choose_us);
                while($data=mysqli_fetch_array($result_why_choose_us))
                {
                    ?>
                 <div class="col-md-4">
                    <div class="target-block text-white p-5 mb-lg-0 mb-xl-0 mb-md-0 mb-sm-5 mb-5" data-aos="fade-up"
                        ...
                        <h4 class="font-weight-bold"><?php echo $data['h1']; ?></h4>

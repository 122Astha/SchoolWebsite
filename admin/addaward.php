                ...
                if($title!="" && $content!="" && $img!="" )
                {
                    ...
                    if($result)
                    {
                      ...
                      <meta http-equiv="refresh" content="0; URL=manageaward.php?msg=csuccess" />
                        <?php
                        echo "Awards is added successfully.";
                    }
                    else 
                    {
                        echo "Awards couldn't added successfully.";
                    }
                }
              ...
              <form action="#" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="longtext" class="form-control" id="exampleInputEmail1" name="content" placeholder="">
                  </div>
                  <div class="form-group">

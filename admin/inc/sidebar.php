      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="addgallery.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Gallery</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="managegallery.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Gallery</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="addgallerycategory.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Gallery Category</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="managegallerycategory.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="manageevent.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Event</p>
                </a>
              </li>
